...
- **达标状态**：管理员汇总页和学生详情页会显示累计学分、达标状态和距离目标学分。
- **审核历史**：活动详情页展示每次审核的状态变化、学分变化、审核意见和审核时间。
- **CSV 导出**：管理员汇总页可导出学生汇总，活动记录页可按关键词、状态和类别导出当前结果。
